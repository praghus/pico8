...
show_numbers = false -- debug mode to show tile ids
...
palette = { 0, 1, 0, 1, 1 } -- single palette (colors sequence)
palette_map = {} -- mapping from color -> next color (built at init)
...
function draw_particles(only_ui)
    if game_state == "title" or level_transition then return end
    for p in all(particles) do
...
function draw_background()
    ...
    if not level_transition and (game_state == "playing" or game_state == "lost" or game_state == "won") then
...
function draw_gui()
    ...
    print_centered(level_text, 2, 7, 5)
...
function draw_title_screen()
    ...
    if not show_leaderboard then
        local xy1 = 15 + k
        local xy2 = 113 + 0.9999 - k
        rectfill(xy1, xy1, xy2, xy2, 0)
        rect(xy1, xy1, xy2, xy2, 1)
...
-- initialize background palette mapping
function init_background_palette()
    -- build a single mapping from color -> next color based on `palette` sequence
    palette_map = {}
    for i = 1, #palette do
        local cur = palette[i]
        local nxt = palette[i % #palette + 1]
        palette_map[cur] = nxt
    end
end
...

...
000000000000000000444444444444000299999999999920056ddddddddddd50057666666666665077777777777777751666666666666610d7777777777777dd
